...
sudo setfacl -R -m u::rwx,g::rwx,g:dls_dasc:rwx,g:gda:rwx,g:gda2:rwx,o::rx,d:u::rwx,d:g::rwx,d:g:dls_dasc:rwx,d:g:gda:rwx,d:o::rx /dls_sw/${BEAMLINE}/software/gda
...
sudo chown gda:dls_dasc /dls_sw/$BEAMLINE/software/gda_versions/var/${BEAMLINE}ssh.key
